...
ap.add_argument('--dataset', type=str, default='cases', help="Dataset string")
...
ap.add_argument('--model', default='AR', choices=['cola_gnn','CNNRNN_Res','RNN','AR','ARMA','VAR','GAR','SelfAttnRNN','lstnet','stgcn','dcrnn'], help='')
...
def evaluate(data_loader, data, tag='val'):
    ...
    np.savetxt('/content/ypred_ar_hosp_1_15.txt', y_pred, delimiter=',')
